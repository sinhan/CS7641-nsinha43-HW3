...
if __name__ == '__main__':
    ...
    dataset1_details = {
            ...
            'readable_name': 'Titanic Survival Rate',
            'best_nn_params': {'NN__activation': ['tanh'], 'NN__alpha': [0.05],
                               'NN__hidden_layer_sizes': [(50, 50, 50)], 'NN__learning_rate_init': [0.016]}
        }
    dataset2_details = {
            'data': loader.WineData(verbose=verbose, seed=seed),
            'name': 'red_wine_quality',
            'readable_name': 'Red Wine Quality',
            'best_nn_params': {'NN__activation': ['logistic'], 'NN__alpha': [0.05],
                               'NN__hidden_layer_sizes': [(50, 50, 50)], 'NN__learning_rate_init': [0.016]}
    }
    if args.dataset1:
